...
{
    class ObjectIdentificationViewModel : PropertyChangedBase, IHandle<TeklaModelObjectProvider>
    {
        ...
        public ObjectIdentificationViewModel(IEventAggregator eventAggregator)
        {
